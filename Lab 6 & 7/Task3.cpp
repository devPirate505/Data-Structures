...
int main (){
    ...
    cout << "The Data in tree is: \n";
    tree1.InOrderTraversal();
    
    cout << "\nThe Parent Nodes in tree are: \n";
    cout << tree1.ParentNode();
    return 0;
}
...
int BinarySearchTree :: ParentNode(node* r){
